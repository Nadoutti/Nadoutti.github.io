...
export const projects: Project[] = [
  {
    ...
    repoUrl: "https://github.com/Nadoutti/RaspiBus"
  },
  {
    name: 'Unofficial Tally SDK',
    description:
      "Acted as the coordinator and PO for an SDK built for Instituto Na Prática after the official Tally API proved too limited for the institute's complex forms and integrations. Used internally to streamline candidate screening for job applications.",
    tech: ['Python', 'REST APIs', 'Automation'],
    repoUrl: "https://github.com/felipeadeildo/pytally-sdk",
    liveUrl: "https://pytally-sdk.fa.dev.br/"
  },

  {
    ...
    repoUrl: "https://github.com/Nadoutti/hash-id"
  },
]
